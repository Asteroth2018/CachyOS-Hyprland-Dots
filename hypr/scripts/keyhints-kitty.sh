...
"Ctrl + Alt + n     |" "Otwórz osobne nowe okno  |" "To nie split tylko nowe okno |" \
"Ctrl + Alt + d     |" "Otwórz nowe okno split   |" "To dzieli okno na pół |" \
"Ctrl + Tab         |" "Przełączaj między oknami |" "Zmienia aktywne okno |" \
...
"Ctrl + Shift + q   |" "Zamknij zakładkę         |" "Zamknij zakładkę w której jesteś |" \
"" "" "" \
